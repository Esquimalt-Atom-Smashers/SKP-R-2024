...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.032166508987701;
        public double lateralInPerTick = 0.0369967355821545;
        public double trackWidthTicks = 656;

        // feedforward parameters (in tick units)
        public double kS = 1.8;
        public double kV = 0.002;
        public double kA = 0.0011;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "rearLeftMotor");
        leftBack = hardwareMap.get(DcMotorEx.class, "frontLeftMotor");
